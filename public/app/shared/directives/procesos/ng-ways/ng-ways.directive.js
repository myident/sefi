        ...
        var Link = function (scope, element, attrs, ngModel) {
            ...
            scope.settingProcesos = function (procesos) {
                ...
                for (i in procesos) {
                    ...
                    for (j in procesos[i][scope.type]) {
...
//                        console.log(offsets[0].x);
            ...
            scope.buildCapacidad = function (capacidad, i, j) {
                ...
                var capacidadHeight = 80;
                var rect, textbox, rectFooterOffset, rectFooter, textboxFooter, intersection, arrow, rectHover, rectTrasparent;
                ...
                if ((Number(j) + 1) < scope.source[i][scope.type].length) {
                    ...
                    //intersections[2][2].x = intersections[2][2].x - (capacidadWidth / 2) - 15;
                ...
                if (capacidad.subcapacidades.length) {
                    ...
                    rectTrasparent.click(function(){
                        ...
                        if(!flag){
                            ...
                            //img.attr({src:'app/modules/processes/assets/img/icono-mas.svg'});
                        }
                        flag = !flag;
            ...
            scope.buildProcesses = function () {
                ...
                for (i in scope.source) {
                    ...
                    var objs = [];
                    for (j in scope.source[i][scope.type]) {
                        var obj = {};
...
//                    console.log('offset Y: ' + scope.objss[i][j].offsets[scope.layout].y);
                    console.log(scope.objss[i][j]);
                    console.log('altura del proceso: ' + heightDelProceso);
                    console.log('altura mayor: ' + countOpens);
...
//                    console.log('countsopen: '+ getHeight());
                } else {
