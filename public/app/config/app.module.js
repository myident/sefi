...
(function () {
    ...
    var directives = ["abcInput", "abcTextarea", "abcSelect", "abcDomain", "abcApplication", "abcArea", "abcBrule", "abcCapability", "abcKpi", "abcMacroprocess", "abcProcess", "abcMegaprocess", "abcTextareaXl", "abcAddInputDouble", "abcAddInputXl", "abcAddInputMultiple", "abcAddNumericInput", "abcAddInputFile", "abcAddSelect"];
